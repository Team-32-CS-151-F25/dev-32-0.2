...
import cs151.application.model.StudentBean;
...
public class ExistingStudentProfileController {
    ...
    public void initialize(){
        ...
        ObservableList<StudentBean> studentBeans = FXCollections.observableArrayList();
        ...
        for (int i = 0; i < profileData.size() ; i++) {
            ...
            studentBeans.add(new StudentBean(name, academicStatus, jobStatus, jobDetails,
                    programmingLang, databases, preferredRole,
                    flags, evaluation));

        }

        studentTableView.setItems(studentBeans);
