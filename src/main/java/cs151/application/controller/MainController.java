...
import cs151.application.model.Faculty;
...
public class MainController {
    ...
    protected void changeScene(ActionEvent event, String fxmlFile) {
        try {
            ...
            if ("/cs151/view/ProgrammingLanguage.fxml".equals(fxmlFile)) {
                refreshLanguageTable(stage);
            }
        } catch (IOException e) {
            e.printStackTrace();
