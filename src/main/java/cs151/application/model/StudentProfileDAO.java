...
public class StudentProfileDAO {
    private static final CSVHandler profileParser = new CSVHandler("src/main/resources/data/studentsProfile.csv");
    ...
    static class Skills {
        private static final CSVHandler skillParser = new CSVHandler("src/main/resources/data/skills.csv");
    ...
    static class Evaluation {
        private static final CSVHandler evaluationParser = new CSVHandler("src/main/resources/data/evaluations.csv");
    ...
    //method to add flags
    static class Flags {
        private static final CSVHandler flagParser = new CSVHandler("src/main/resources/data/flags.csv");
